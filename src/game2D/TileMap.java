...
public class TileMap 
{
	...
	protected Tile [][] tmap;		// The tile map grid, initially null
	protected int mapWidth=0;		// The maps width in tiles
	protected int mapHeight=0;	// The maps height in tiles
	protected int tileWidth=0;	// The width of a tile in pixels
	protected int tileHeight=0;	// The height of a tile in pixels
